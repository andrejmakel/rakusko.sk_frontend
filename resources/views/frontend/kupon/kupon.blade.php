...
{{-- <script>
    ...
    function process()
    {
        var url = "pic/" + document.getElementById("url").value + "/TGS_Discount_Kupon_SK_012022.pdf";
        location.href = url;
        return false;    
    }
...
<div class="col-4">
     <input class="form-control text-center url" id="url" type="text" placeholder="Zadaj kód" onkeyup="enableSubmit()">
      ...
      <br>
      <div class="d-flex justify-content-center">
          <input type="submit" class="btn btn-danger" value="Stiahni a vytlač zľavový kupón">
      </div>
</form> --}}


<div class="d-flex justify-content-center">
  <a href="/pic/TGS_Discount_Kupon_SK_082023.pdf" target="_blank">
    <button class="btn btn-danger">
      Stiahni a vytlač zľavový kupón
    </button>
  </a>
</div>
...
{{--         <div class="my-4 rounded" id="thumbnail">
          ...
          <a href="https://shop.asfinag.at/sk/" target="_blank" class="stretched-link">
            <img src="pic/dialnica_thumbnail.jpg" class="rounded img-fluid mx-auto d-block" alt="dom_mora"> 
          </a>
